...
public interface IComicFileSystemService
{
    ...
    public Task<Stream> GetImageAsync(DateOnly date, SourceType source, CancellationToken cancellationToken = default);
    /// <summary>
    ...
    /// <param name="date">Comic date</param>
    /// <param name="source">Comic source type</param>
    public Task SaveImageAsync(Stream stream, DateOnly date, SourceType source, CancellationToken cancellationToken = default);
}
